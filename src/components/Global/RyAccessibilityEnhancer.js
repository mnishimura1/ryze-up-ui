...
export const RyAccessibilityEnhancer = ({ children }) => {
    ...
    useEffect(() => {
        ...
        const contrastListener = (e) => setPrefersHighContrast(e.matches);
    ...
    return (_jsxs("div", { role: "application", "aria-label": "RYZE-UP Trading Dashboard", "data-reduced-motion": prefersReducedMotion, "data-high-contrast": prefersHighContrast, className: `${prefersReducedMotion ? 'reduce-motion' : ''} ${prefersHighContrast ? 'high-contrast' : ''}`, children: [_jsx("style", { children: `
      ...
      ` }), _jsx("a", { href: "#main-content", className: "sr-only", children: "Skip to main content" }), children] }));
};
